...
},{"./pokeApp":2,"react":164}],2:[function(require,module,exports){
'use strict';
...
var _pokeHeader = require('./pokeHeader');

var _pokeHeader2 = _interopRequireDefault(_pokeHeader);
...
var PokeApp = (function (_React$Component) {
	...
	_createClass(PokeApp, [{
		key: 'onGrowl',
		value: function onGrowl(name, color) {
			var text = name + ', ' + name + '!';
			var msg = { id: (0, _uid2['default'])(), text: text, color: color };
		...
		value: function render() {
			var pokemons = [{ number: 1, name: 'Bulbasaur', color: '#F22613' }, { number: 2, name: 'Ivysaur', color: '#663399' }, { number: 3, name: 'Venusaur', color: '#26A65B' }];
			return _react2['default'].createElement(
				'div',
				{ className: 'pokeapp' },
				_react2['default'].createElement(_pokeHeader2['default'], null),
...
},{"./pokeChat":4,"./pokeHeader":5,"./pokeTable":8,"react":164,"uid":165}],3:[function(require,module,exports){
'use strict';
...
},{"./pokeMessage":6,"react":164}],5:[function(require,module,exports){
'use strict';
...
var PokeHeader = (function (_React$Component) {
	_inherits(PokeHeader, _React$Component);

	function PokeHeader() {
		_classCallCheck(this, PokeHeader);

		_get(Object.getPrototypeOf(PokeHeader.prototype), 'constructor', this).apply(this, arguments);
	}

	_createClass(PokeHeader, [{
		key: 'render',
		value: function render() {
			return _react2['default'].createElement(
				'header',
...
var PokeMessage = (function (_React$Component) {
	...
	_createClass(PokeMessage, [{
		...
		value: function render() {
			...
			return _react2["default"].createElement(
				"li",
				{ className: "pokemessage", style: style },
	...
	_createClass(PokeRow, [{
		...
		value: function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement('div', { className: 'poke-color', style: style }),
...
},{"./pokeAvatar":3,"react":164}],8:[function(require,module,exports){
'use strict';
...
},{"./pokeRow":7,"react":164}],9:[function(require,module,exports){
